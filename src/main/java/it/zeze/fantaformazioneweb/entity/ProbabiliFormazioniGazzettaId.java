...
public class ProbabiliFormazioniGazzettaId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6131914766609541323L;
	...
	public boolean equals(Object other) {
		...
		return (this.getIdGiocatore() == castOther.getIdGiocatore()) && (this.getIdGiornata() == castOther.getIdGiornata()) && ((this.isTitolare() == castOther.isTitolare()) || (this.isPanchina() == (castOther.isPanchina())));
	}
